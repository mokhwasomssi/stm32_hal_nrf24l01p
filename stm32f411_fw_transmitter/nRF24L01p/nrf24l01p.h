...
void nrf24l01p_rx_read_payload();
void nrf24l01p_tx_write_payload();

read_reg nrf24l01p_read_register(uint8_t reg);
write_reg nrf24l01p_write_register(uint8_t reg, uint8_t value);

status_reg nrf24l01p_get_status();
status_reg nrf24l01p_get_fifo_status();
